...
<body style='background-color: cornsilk;'>
	...
	<center>
		...
		<form action="modifycompany_2.jsp" method="post">
			<h3>
				<font color="blue">请核对您的用户名： </font>
			</h3>
			<br> <select name="companyname"
				style="font-size: 20px; font-family: '微软雅黑'; font-style: bold;">

				<%
					String companyname = (String) session.getAttribute("companyname");
					try {
						rs = stmt.executeQuery("select * from tb_company where name=" + "'" + companyname + "'");
