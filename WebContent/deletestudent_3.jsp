...
<jsp:include page="header-admin.jsp"></jsp:include>
	...
	System.out.print("数据库连接成功");
		...
		String sql_1 = "select * from tb_student  where name='" + studentname.trim() + "'";
		...
		String sql = "delete from tb_student where name='" + studentname + "'";
	...
	<center>
		...
		<h2><font color="blue"><%=studentname%></font>已经被删除！</h2>
		<br><br>
