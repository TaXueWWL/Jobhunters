...
<body>
	...
	<div class="inset">
		...
		<form class="register" action="studentRegisterServlet">
			登录名 <input type="text" name="username" width="25" id="inputBox1_1"
				onblur="checkUserName();" /> <span id="usernameSpan"></span> <br />
			密&nbsp;&nbsp;&nbsp;码 <input type="password" name="password"
				width="30" id="inputBox1_2" onblur="checkPass()" /> <span
				id="passwordSpan"></span> <br /> <br /> 
			确&nbsp;&nbsp;&nbsp;认 <input
				type="password" name="rePassword" width="30" id="inputBox1_3"
				onblur="checkRePass()" /> <span id="rePasswordSpan"></span> <br />
			<br />
